...
| [Prompt moderation evidence reference](prompt_moderation_evidence.md) | What the horde retains when a prompt is rejected, a worker reports a job, or a worker draws suspicion; how long it keeps it; and the moderator API over it and over promotion review. |

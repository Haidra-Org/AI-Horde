...
class PromptChecker:
    ...
    def __init__(self):
        ...
        self.nsfw_model_regex = re.compile(r"girl|boy|student|\byoung\b|lit[tl]le|\blil\b|small|tiny", re.IGNORECASE)
        self.nsfw_model_anime_regex = re.compile(r"(?<!1)girl|(?<!1)boy|student|\byoung\b|lit[tl]le|\blil\b|small|tiny", re.IGNORECASE)

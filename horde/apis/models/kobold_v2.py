...
class TextModels(v2.Models):
    def __init__(self,api):
        ...
        self.root_model_generation_payload_kobold = api.model('ModelPayloadRootKobold', {
            ...
            'max_context_length': fields.Integer(min=80, default=1024, max=32000, description="Maximum number of tokens to send to the model."), 
        ...
        self.response_model_job_pop = api.model('GenerationPayload', {
            ...
            'ids': fields.List(fields.String(description="The UUID for this text generation.", example="00000000-0000-0000-0000-000000000000")),
        ...
        self.input_model_job_submit = api.inherit('SubmitInputKobold', self.input_model_job_submit, {

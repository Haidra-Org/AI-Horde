...
class Models(v2.Models):
    def __init__(self,api):
        ...
        self.root_model_generation_payload_kobold = api.model('ModelPayloadRootKobold', {
            ...
            'soft_prompt': fields.String(description="Soft prompt to use when generating. If set to the empty string or any other string containing no non-whitespace characters, uses no soft prompt.", required=False, min_length = 1),

...
class Parsers:
    ...
    job_pop_parser.add_argument("bridge_agent", type=str, required=False, default="AI Horde Worker:11:https://github.com/db0/AI-Horde-Worker", location="json")
...
class Models:
    def __init__(self,api):
        ...
        self.input_model_job_pop = api.model('PopInput', {
            ...
            'bridge_agent': fields.String(required=False, default="AI Horde Worker:11:https://github.com/db0/AI-Horde-Worker", description="The worker name and website", max_length=1000),

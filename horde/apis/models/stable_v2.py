...
class Models(v2.Models):
    def __init__(self,api):
        ...
        self.input_model_interrogation_pop = api.model('InterrogationPopInput', {
            ...
            'bridge_agent': fields.String(required=False, default="AI Horde Worker:11:https://github.com/db0/AI-Horde-Worker", description="The worker name, version and website", max_length=1000),

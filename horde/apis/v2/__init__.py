...
api.add_resource(stable.ImageAsyncRequest, "/generate/request/<string:id>")
...
api.add_resource(kobold.TextAsyncRequest, "/generate/text/request/<string:id>")
...
api.add_resource(stable.ImageSamplerConstraints, "/status/sampler_constraints")
...
api.add_resource(moderation.OperationsWorkerSuspicionEvents, "/operations/worker_suspicion_events")

...
class Aesthetics(Resource):
    ...
    post_parser.add_argument("user_agent", type=str, required=False, help="The client name and version", location="header")
...
class Interrogate(Resource):
    ...
    post_parser.add_argument("user_agent", type=str, required=False, help="The client name and version", location="headers")

from horde.database.threads import store_prioritized_wp_queue, check_waiting_prompts, assign_monthly_kudos, store_worker_list, store_available_models, store_totals
...
store_totals = PrimaryTimedFunction(60, store_totals)
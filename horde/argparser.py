...
arg_parser.add_argument('--prevent_date_change', action='store_true', required=False, help="If true will prevent changing the reward date when forcing patreon rewards.")

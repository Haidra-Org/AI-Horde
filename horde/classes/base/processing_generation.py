    ...
    def __init__(self, *args, **kwargs):
        ...
        if kwargs.get('model') is None:
            ...
            if len(matching_models) == 0:
                logger.warning("Unexpectedly No models matched between worker and request!: Worker Models: {worker_models}. Request Models: {wp_models}. Will use random worker model.")
                matching_models = worker_models
